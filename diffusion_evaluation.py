...
pipeline = StableDiffusionPipeline.from_pretrained("/scratch/s1889338/diffusers/examples/text_to_image/sd-landscape-model/", torch_dtype=torch.float16, use_safetensors=True).to("cuda")
...
with open('output_diffusion_evaluation.csv', mode='w', encoding='utf-8', newline='') as outfile:
    ...
    for image_filename in os.listdir("./images"):
        ...
        try:
            ...
            for i in range(20):
                ...
                image.save(f"images/{image_name}_{i}.png")
